...
"
The "complex computation" in our case is simply downloading the buf binary from github.
...
PLATFORMS = {
    ...
    "Windows-arm64.exe": struct(
        compatible_with = [
            "@platforms//os:windows",
            "@platforms//cpu:arm64",
        ],
    ),
    "Windows-x86_64.exe": struct(
        compatible_with = [
            "@platforms//os:windows",
            "@platforms//cpu:x86_64",
        ],
...
# By default all these toolchains are registered by the buf_register_toolchains macro
...
toolchains_repo = repository_rule(
    ...
    attrs = {
        "user_repository_name": attr.string(
            doc = "what the user chose for the base name, eg. buf",
            default = "buf",
        ),
    },
)
